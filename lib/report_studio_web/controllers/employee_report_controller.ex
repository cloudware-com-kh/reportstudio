defmodule ReportStudioWeb.Controllers.EmployeeReportController do
  ...
  def show(conn, _params) do
    ...
    html_string =
      ReportStudioWeb.Controllers.EmployeeReportHTML.report(assigns)
      |> Phoenix.HTML.Safe.to_iodata()
      |> IO.iodata_to_binary()

    # 2. Read the compiled Tailwind CSS safely
    css_path = Application.app_dir(:report_studio, "priv/static/assets/css/employee_report.css")
